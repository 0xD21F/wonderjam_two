...
impl FromWorld for CustomPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let shader = asset_server.load("shader/instancing.wgsl");
...
//     let ground_mesh = meshes.add(Mesh::from(shape::Plane { size: TILE_SIZE }));
//     let ground_material = materials.add(Color::rgb(0.0, 0.9, 0.0).into());
...
//             //         transform: Transform::from_xyz(x as f32 * TILE_SIZE, 0., y as f32 * TILE_SIZE),
//             //         ..default()
//             //     })
//             //     .id();
//             // tiles.push(tile);
